...
|:----------:|:---------:|:----------------------------------:|:--------------:|:---------:|:-------:|:-------:|:--------:|
| ERes2NetV2 |    6.6    | [CN-Celeb](http://openslr.org/82/) |      2796      |   0.20    | 0.08071 | 0.45720 | 加入知识星球获取 |
|  ERes2Net  |    6.6    | [CN-Celeb](http://openslr.org/82/) |      2796      |   0.20    | 0.08125 | 0.45574 | 加入知识星球获取 |
|   CAM++    |    6.8    | [CN-Celeb](http://openslr.org/82/) |      2796      |   0.23    | 0.08336 | 0.48542 | 加入知识星球获取 |
|  ResNetSE  |    7.8    | [CN-Celeb](http://openslr.org/82/) |      2796      |   0.19    | 0.08544 | 0.49145 | 加入知识星球获取 |
| EcapaTdnn  |    6.1    | [CN-Celeb](http://openslr.org/82/) |      2796      |   0.24    | 0.09254 | 0.51364 | 加入知识星球获取 |
|    TDNN    |    2.6    | [CN-Celeb](http://openslr.org/82/) |      2796      |   0.24    | 0.10831 | 0.59551 | 加入知识星球获取 |
|  Res2Net   |    5.0    | [CN-Celeb](http://openslr.org/82/) |      2796      |   0.26    | 0.15658 | 0.67347 | 加入知识星球获取 |
|   CAM++    |    6.8    |               更大数据集                |      2W+       |   0.34    | 0.07884 | 0.52738 | 加入知识星球获取 |
|   CAM++    |    6.8    |               其他数据集                |      20W       |   0.29    | 0.04768 | 0.31429 | 加入知识星球获取 |
| ERes2NetV2 |   56.2    |               其他数据集                |      20W+      |   0.36    | 0.03840 | 0.24315 | 加入知识星球获取 |
...
|     模型     | Params(M) |     数据集     | train speakers | threshold |   EER   | MinDCF  |   模型下载   |
|:----------:|:---------:|:-----------:|:--------------:|:---------:|:-------:|:-------:|:--------:|
|   CAM++    |    6.8    | VoxCeleb1&2 |      7205      |   0.23    | 0.02437 | 0.15546 | 加入知识星球获取 |
| EcapaTdnn  |    6.1    | VoxCeleb1&2 |      7205      |   0.25    | 0.02471 | 0.16138 | 加入知识星球获取 |
| ERes2NetV2 |    6.6    | VoxCeleb1&2 |      7205      |   0.21    | 0.02735 | 0.17692 | 加入知识星球获取 |
|  ERes2Net  |    6.6    | VoxCeleb1&2 |      7205      |   0.20    | 0.02947 | 0.17314 | 加入知识星球获取 |
|  ResNetSE  |    7.8    | VoxCeleb1&2 |      7205      |   0.23    | 0.03197 | 0.23065 | 加入知识星球获取 |
|    TDNN    |    2.6    | VoxCeleb1&2 |      7205      |   0.24    | 0.03489 | 0.26796 | 加入知识星球获取 |
|  Res2Net   |    5.0    | VoxCeleb1&2 |      7205      |   0.27    | 0.05891 | 0.49239 | 加入知识星球获取 |
